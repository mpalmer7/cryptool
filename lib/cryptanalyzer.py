...
class cipher:
	def __init__(self, name, cod, sod, words):
		...
		self.codc = cod	 #dic, character occurance percentage
		self.sodc = sod	 #dic, set occurance percentage
...
def cryptanalysis(ctext):	#strig
	...
	#name, cod, sod, words 
	binary = cipher("binary", {"1":10,"0":10, " ":5, "OTHER":0}, {L_ALPHA:0, U_ALPHA:0, NUMERICALS:10, SYMBOLS:0, SPACE:5}, {True:5, False:5})
	b64 = cipher("b64", {"OTHER":5}, {L_ALPHA:5, U_ALPHA:5, NUMERICALS:5, SYMBOLS:0, SPACE:0}, {True:0, False:10})
	morse = cipher("morse", {".":10, "-":10, " ":5, "OTHER":0}, {L_ALPHA:0, U_ALPHA:0, NUMERICALS:0, SYMBOLS:10, SPACE:5}, {True:10, False:0})
	singlebyteXOR = cipher("singlebyteXOR", {"OTHER":5}, {L_ALPHA:5, U_ALPHA:5, NUMERICALS:5, SYMBOLS:0, SPACE:0}, {True:0, False:10})
	subtypeciphers = cipher("subtypeciphers", {"OTHER":5}, {L_ALPHA:10, U_ALPHA:10, NUMERICALS:0, SYMBOLS:0, SPACE:5}, {True:10, False:5})
	hashsearch = cipher("hashsearch", {"OTHER":5}, {L_ALPHA:5, U_ALPHA:5, NUMERICALS:5, SYMBOLS:0, SPACE:0}, {True:0, False:10})
